...
var db_connection_js_1 = require("./data/db-connection.js");
var Heroinfo_js_1 = require("./models/Heroinfo.js");
var heroinfos_js_1 = require("./data/heroinfos.js");
dotenv_safe_1["default"].config();
var heroInfoDBConnection = (0, db_connection_js_1.connectDB)();
...
var urlPromise = function () { return __awaiter(void 0, void 0, void 0, function () {
    var url;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4, (0, standalone_1.startStandaloneServer)(server, {
                    context: function () { return __awaiter(void 0, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            ...
                            return [2, {
                                    dataSources: {
                                        heroinfos: new heroinfos_js_1["default"](Heroinfo_js_1.Heroinfo)
                                    }
                                }];
                        });
                    }); },
